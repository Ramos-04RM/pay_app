...
class DailyPaymentLogicTests(TestCase):
    ...
    def create_cabinet(self, **kwargs):
        data = {
    ...
    def create_pay(self, cabinet, **kwargs):
    ...
    def test_is_daily_payment_false_no_recalculation(self):
        ...
        with patch('pay_app.services.timezone.localdate', return_value=self.fixed_today):
    ...
    def test_balance_null_treated_as_zero(self):
    ...
    def test_balance_zero_sets_paid_up_to_today(self):
    ...
    def test_single_active_service(self):
        ...
        pay.refresh_from_db()
        self.assertEqual(pay.paid_up_to, self.fixed_today + timedelta(days=54))

    def test_multiple_active_services_same_date(self):
        ...
        expected_date = self.fixed_today + timedelta(days=27)
    ...
    def test_inactive_services_ignored(self):
        ...
        self.assertEqual(active_pay.paid_up_to, self.fixed_today + timedelta(days=27))
        self.assertEqual(inactive_pay.paid_up_to, inactive_date)

    def test_active_service_with_non_positive_price_blocks_recalculation(self):
    ...
    def test_balance_change_triggers_recalculation(self):
        cabinet = self.create_cabinet(balance=Decimal('27.00'), is_daily_payment=True)
        pay = self.create_pay(cabinet=cabinet, price_per_month=27)
    ...
    def test_is_daily_payment_switch_to_true_triggers_recalculation(self):
    ...
    def test_create_active_pay_triggers_recalculation(self):
        cabinet = self.create_cabinet(balance=Decimal('27.00'), is_daily_payment=True)
    ...
    def test_price_change_triggers_recalculation(self):
        cabinet = self.create_cabinet(balance=Decimal('54.00'), is_daily_payment=True)
        pay = self.create_pay(cabinet=cabinet, price_per_month=27)
    ...
    def test_status_change_triggers_recalculation(self):
        cabinet = self.create_cabinet(balance=Decimal('54.00'), is_daily_payment=True)
        pay1 = self.create_pay(cabinet=cabinet, price_per_month=27)
        ...
        pay1.refresh_from_db()
        pay2.refresh_from_db()
        self.assertEqual(pay1.paid_up_to, self.fixed_today + timedelta(days=54))
        self.assertNotEqual(pay2.status, 'active')

    def test_move_pay_to_another_cabinet_recalculates_both(self):
        ...
        self.assertEqual(old_pay_1.paid_up_to, self.fixed_today + timedelta(days=54))
        self.assertEqual(moving_pay.paid_up_to, self.fixed_today + timedelta(days=13))
        self.assertEqual(new_pay.paid_up_to, self.fixed_today + timedelta(days=13))

    def test_delete_pay_triggers_recalculation(self):
        cabinet = self.create_cabinet(balance=Decimal('54.00'), is_daily_payment=True)
        pay1 = self.create_pay(cabinet=cabinet, price_per_month=27)
        pay2 = self.create_pay(cabinet=cabinet, price_per_month=27)
    ...
    def test_days_are_rounded_down(self):
